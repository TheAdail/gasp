...
public class RateActivity extends AppCompatActivity implements View.OnClickListener, SendData.OnAsyncRequestComplete, GPSTracker.LocationUpdateListener {
...
SendData sendData;
    ...
    public void sendData() {
        sendData = new SendData(RateActivity.this);
    ...
    public void asyncError(int id) {
        AppUtil.showServiceError(RateActivity.this, id);
    }
...
//        getUserLocation = new GetUserLocation(RateActivity.this,
//                progressDialog, gps);
